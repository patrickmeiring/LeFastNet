...
namespace NeuralNetworkOCR
{
    class DataSets
    {
        ...
        private static IList<DataSetItem> LoadTrainingDataset()
        {
            ...
            {
                DataSetItem[] set = DataSets.LoadLeCunSet(TrainingDatasetImages, TrainingDatasetLabels);
                DataSets.SaveNativeSet(TrainingDatasetCache, set);
                return set;
            }
            else
            {
                return DataSets.LoadNativeSet(TrainingDatasetCache);
            }
        }
        ...
        private static IList<DataSetItem> LoadGeneralisationDataset()
        {
            ...
            {
                DataSetItem[] set = DataSets.LoadLeCunSet(GeneralisationDatasetImages, GeneralisationDatasetLabels);
                DataSets.SaveNativeSet(GeneralisationDatasetCache, set);
                return set;
            }
            else
            {
                return DataSets.LoadNativeSet(GeneralisationDatasetCache);
            }
        }
